...
public class Fotos_Parq_Rel extends AppCompatActivity {
    RecyclerView recy;
    FloatingActionButton btnreg, btndel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fotos_parq_rel);
        recy=(RecyclerView) findViewById(R.id.recyclparq);
        btnreg=(FloatingActionButton) findViewById(R.id.regbtnparq);
        btndel=(FloatingActionButton) findViewById(R.id.btndelfotpar);
        ...
        btnreg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new  Intent(getApplicationContext(), Fotos_Parq_Reg.class);
        ...
        btndel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (dell>0) {
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(Fotos_Parq_Rel.this);
                    alertDialog.setMessage("¿Desea eliminar la fotografia " + nombre + "?")
                            .setCancelable(false)
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    dell(String.valueOf(dell));
                                    finish();
                                }
    ...
    private void  ObtenerDatos(String id_par){
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (succes.equals("1")) {
                        ...
                        AdapRecyFotos adapRecyFotos =new AdapRecyFotos(Fotos_Parq_Rel.this, fotosEntList,new AdapRecyFotos.ItemClickListenerFoto() {
                            @Override
                            public void onItemClick(FotosEnt details) {
                                dell= Integer.parseInt(details.getIDfoto());
        ...
        StringRequest request=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response.equalsIgnoreCase("succes")) {
                    ...
                    startActivity(new Intent(getApplicationContext(), Fotos_Parq.class));
                } else {
